  ...
  return (
    <>
      ...
      <section className="px-4 py-4">
        <Card className="h-64 flex items-center justify-center bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-dashed border-blue-200">
          <div className="text-center">
            <MapPin className="w-12 h-12 text-blue-400 mx-auto mb-2" />
            <h3 className="font-semibold text-slate-800 mb-1">Interactive Map</h3>
            <p className="text-sm text-slate-600">Map integration coming soon</p>
          </div>
        </Card>
      </section>
      ...
      <section className="px-4 py-2">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-slate-800">Nearby Fishing Spots</h3>
            ...
            <Card key={spot.id} className="overflow-hidden">
              <div className="relative h-40">
                ...
                <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full">
                  <span className="text-xs font-medium text-slate-700">2.3 mi</span>
                </div>
              </div>
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h4 className="font-semibold text-slate-800">{spot.name}</h4>
